...
import { ChevronLeft, ChevronRight, Clock, CheckCircle2, AlertTriangle, Package } from "lucide-react"
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-1 pb-20">
        <div className="container px-4 py-6">
          {/* Search orders */}
          <div className="mb-6">
            <Input placeholder="Buyurtma raqami bo'yicha qidirish..." className="h-12" />
          </div>
          ...
          <Tabs defaultValue="all" className="w-full">
            <TabsList className="w-full grid grid-cols-4 mb-4">
              ...
              <TabsTrigger value="cancelled">Bekor qilindi</TabsTrigger>
            </TabsList>
